...
public class H2Util {
    ...
    public static boolean createDB() {
        try {
            ...
            String path = new File("").getAbsolutePath() +
                    "/src/main/java/com/hillel/homework_4/scripts/createTables/createTables.sql";
    ...
    public static boolean dropDB() {
        try {
            String pathToScript = new File("").getAbsolutePath() +
                    "/src/main/java/com/hillel/homework_4/scripts/dropTables/dropTables.sql";
            Connection connection = connect();
